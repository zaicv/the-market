    ...
    <div className="glass-card relative flex flex-col gap-5 overflow-hidden rounded-3xl p-8 transition-transform duration-300 hover:-translate-y-1">
      ...
      <div className="relative z-10 mt-auto flex flex-col gap-3">
        {available ? (
          <a
            href={downloadUrl!}
            className="flex items-center justify-between rounded-2xl bg-[var(--text-primary)] px-5 py-3 text-[var(--bg-from)] transition-transform hover:scale-[1.02] active:scale-[0.98]"
          >
